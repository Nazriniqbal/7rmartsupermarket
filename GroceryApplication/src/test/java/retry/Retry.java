...
public class Retry implements IRetryAnalyzer {
	...
	private static final Logger LOG = (Logger) LogManager.getLogger("Retry.class"); //logger is initialized to track and log test retry attempt using log4J
	private static final int maxTry = 3;  //maximum no. of retry attempts
	private int count = 0; // how many times the retry attempted for the current test case
